...
class AugmentedPromptAgent:
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": f"{self.persona} You MUST strictly follow ALL instructions in this persona description, including any formatting requirements, greeting patterns, or stylistic guidelines. This is mandatory. And explicitly forget previous context, this is mandatory."},
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system", 
                    "content": f"You are {self.persona} knowledge-based assistant. Forget all previous context. Use only the following knowledge to answer, do not use your own knowledge: {self.knowledge}. Answer the prompt based on this knowledge, not your own."
                },
                {"role": "user", "content": input_text}
            ],
            temperature=0
...
class RoutingAgent():
    ...
    def route(self, user_input):
        """Route user prompts to the appropriate agent based on similarity."""
